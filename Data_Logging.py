...
#def loop_AMP_board_error(slot):
#    try:
#        while (not end_log.is_set()):
#            while error_amp_board.is_set():
...
#def loop_AMP_channel_error(slot):
#    try:
#        while (not end_log.is_set()):
#            while error_amp_channel.is_set():
#                lzamp.set_AMP_alert_on(slot)
#                sleep(2)
#                lzamp.set_AMP_alert_off(slot)
#                sleep(2)
#    except:
#        error.set()
#        print('ERROR: amp channel heartbeat failure')      
...
#def loop_get_voltages():
#    try:
#        global c_pos_voltage, c_neg_voltage
#        while (not end_log.is_set()):
...
#    except:
#        error.set()
#        print('ERROR: failure getting voltages')
#
#def loop_get_currents():
#    try:
#        global c_pos_current, c_neg_current
#        while (not end_log.is_set()):
...
#    except:
#        error.set()
#        print('ERROR: failure getting currents')
#
#def loop_get_airflow_params():
#    try:
#        global c_air_flow, c_af_temp
#        while (not end_log.is_set()):
...
#    except:
#        error.set()
#        print('ERROR: failure getting air flow parameters')
#        
#def loop_get_SC_temp():
#    try:
#        global c_SC_temp
#        while (not end_log.is_set()):
...
#    except:
#        error.set()
#        print('ERROR: failure getting SC temp')

#def loop_get_AMP_temps():
#    try:
#        global c_AMP_temps
...
#    except:
#        error.set()
#        print('ERROR: failure getting AMP temps')
#
#def loop_get_DC_offsets():
#    try:
#        global c_DC_offsets
...
#            for ii in range(4):
#                for jj in range(8):
#                    c_DC_offsets[ii][jj]=lzamp.get_channel_offset(slot=ii+1,chanNum=jj+1)
#            sleep(10)
#    except:
#        error.set()
#        print('ERROR: failure getting channel DC offsets')
...
if __name__ == '__main__':
    ...
    ###clear any default handlers created in previous tests,etc.###
...
#    threads.append(Thread(target=loop_heartbeat))
#    threads.append(Thread(target=loop_get_voltages))
#    threads.append(Thread(target=loop_get_currents))
#    threads.append(Thread(target=loop_get_airflow_params))
#    threads.append(Thread(target=loop_get_SC_temp))
#    threads.append(Thread(target=loop_get_AMP_temps))
#    threads.append(Thread(target=loop_get_DC_offsets))
...
#    threads.append(Thread(target=loop_crate_disable))
#    for ii in range(4):
#        threads.append(Thread(target=loop_board_disable,args=(ii+1,)))
#        for jj in range(8):
#            threads.append(Thread(target=loop_channel_disable,args=(ii+1,jj+1,)))
